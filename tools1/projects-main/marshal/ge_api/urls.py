...
urlpatterns = [
    ...
    path('update_column_and_asset/',
         views.update_wizard_with_asset_and_col_data_view),
    path('update_ces_to_wizard/', views.update_selected_ce_to_wizard_flow_view),
    path('update_expectation_suite/',
         views.update_expectation_suite_to_wizard_flow_view),
    path('update_status_to_wizard/', views.update_status_to_wizard_flow_view),
    path('get_wizard_detail/', views.get_wizard_detail_view),
    path('get_datasource_detail/<str:ds_name>/',
         views.get_datasource_details_view),
