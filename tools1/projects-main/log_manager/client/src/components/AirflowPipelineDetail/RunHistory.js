          ...
          >
            ...
            >
              <tr style={{ color: "black" }}>
                {/* <th>Pipeline Name</th> */}
                <th>Dag ID</th>
                <th style={{ width: 75 }}>Run State</th>
                <th style={{ width: 200 }}>Logical Date</th>
                <th>Dag Run ID</th>
                <th style={{ width: 200 }}>Start Date</th>
                <th style={{ width: 200 }}>End Date</th>
                <th style={{ width: 200 }}>Execution Date</th>
                {/* <th style={{ width: 200 }}>Logical Date</th> */}
            ...
            <tbody>
              {/* {data.dags.map((value) => (
                  <tr>
                    <td>{value.dag_id}</td> */}
              {/* <td>{value.dag_run_id}</td> */}
              {/* <td>success</td>
                    <td>{myFunction(value.next_dagrun)}</td> */}
              {/* <td>{secondsToHms(value.last_parsed_time)}</td> */}

              {/* </tr>
                ))} */}
              {data.dag_runs.map((value) => (
                <tr>
                  {/* <td>{value.dag_id}</td> */}
                  <td>{value.dag_id}</td>
                  <td>
