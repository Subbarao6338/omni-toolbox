...
import AlertV2 from "./pages/AlertV2";
import AirflowPipelineRun from "./components/AirflowPipelineDetail";
      ...
      <ErrorBoundary>
        <Routes>
          <Route element={<DrawerNav />}>
            ...
            <Route path="/pipeline_run">
              <Route index element={<PipelineRuns />} />
              <Route path=":dag_id">
                <Route index element={<PipelineRuns />} />
                <Route path=":dag_run_id" element={<AirflowPipelineRun />} />
              </Route>
            </Route>
            <Route path="/alert_v2" element={<AlertV2 />} />
          </Route>
