...
def start_simulator(request):
    ...
    attributes = request_data_json['attributes']
    noise = request_data_json['noise']
    hub_name = request_data_json['hub_name']
    device_count = int(request_data_json['device_count'])
    time_delay_ms = int(request_data_json['time_delay'])
    time_delay = time_delay_ms/1000.0
    ...
    if simulation_type == "Rule_Based":
        ...
        sdv_simulator.sent_synthetic_data(cloud_service_type, time_delay, hub_name, attributes, noise)
