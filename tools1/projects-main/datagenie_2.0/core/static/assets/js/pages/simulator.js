...
//
//$('input[type=checkbox][name="data_options"]').change(function() {
//    if ($(this).val() == 'telemetry') {
//         document.getElementById("attribute_anomaly").style.display = 'none';
//         document.getElementById("noise_anomaly").style.display = 'none';
//    }
//    else if($(this).val() == 'anomaly')
//     {
//         document.getElementById("attribute_anomaly").style.display = '';
//         document.getElementById("noise_anomaly").style.display = '';
//    }
//});
...
function get_setting_details() {
  $.get("/get_setting_details", function (response) {
    ...
    document.getElementsByName("azure_subscription_id")[0].value =
      typeof jsonParsedArray["azure_subscription_id"] === "undefined"
        ? ""
        : jsonParsedArray["azure_subscription_id"];
    document.getElementsByName("iot_hub_name")[0].value =
      typeof jsonParsedArray["iot_hub_name"] !== "undefined"
        ? jsonParsedArray["iot_hub_name"]
        : "";
    document.getElementsByName("iot_connection_string")[0].value =
      typeof jsonParsedArray["iot_connection_string"] !== "undefined"
        ? jsonParsedArray["iot_connection_string"]
        : "";
    document.getElementsByName("event_hub_name")[0].value =
      typeof jsonParsedArray["event_hub_name"] !== "undefined"
        ? jsonParsedArray["event_hub_name"]
        : "";
    document.getElementsByName("event_hub_connection_string")[0].value =
      typeof jsonParsedArray["event_hub_connection_string"] !== "undefined"
        ? jsonParsedArray["event_hub_connection_string"]
        : "";
    document.getElementsByName("sdv_model_name")[0].value =
      jsonParsedArray["sdv_model_name"];
    document.getElementsByName("azure_storage_connection_string")[0].value =
      typeof jsonParsedArray["azure_storage_connection_string"] !== "undefined"
        ? jsonParsedArray["azure_storage_connection_string"]
        : "";

    document.getElementsByName("aws_access_key_id")[0].value =
      typeof jsonParsedArray["aws_access_key"] !== "undefined"
        ? jsonParsedArray["aws_access_key"]
        : "";
    document.getElementsByName("aws_secret_key_id")[0].value =
      typeof jsonParsedArray["aws_secret_key"] !== "undefined"
        ? jsonParsedArray["aws_secret_key"]
        : "";
    document.getElementsByName("aws_region")[0].value =
      typeof jsonParsedArray["aws_region"] !== "undefined"
        ? jsonParsedArray["aws_region"]
        : "";
    document.getElementsByName("aws_stream_name")[0].value =
      typeof jsonParsedArray["aws_stream_name"] !== "undefined"
        ? jsonParsedArray["aws_stream_name"]
        : "";
    ...
    fetch("/get_sdv_models")
      ...
      .then((data) => {
        ...
        $(model_list).each(function () {
          select_el.append(
            $("<option>").attr("value", this.sdv_model).text(this.sdv_model)
          );
...
function get_schema() {
  $.get("/get_setting_details", function (response) {
    ...
    document.getElementById("selected_schema").value =
      jsonParsedArray["msg_template"];
  });
}
var global_id = "";
