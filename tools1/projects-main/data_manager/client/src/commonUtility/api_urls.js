...
export const update_service_request_url =
  "servicerequest/update_servicerequest";
export const delete_service_request_url =
  "servicerequest/delete_servicerequest";
...
export const listDateWiseCostDetails =
  "usagemonitoring/listDateWiseCostDetails";
...
export const create_kubernetescluster_url ="autodeploy/create_kubernetescluster";
export const delete_kubernetescluster_url ="autodeploy/delete_kubernetescluster";
export const iskubernetesclusterexists_url ="autodeploy/is_kubernetes_cluster_exists";
export const get_projectname_url ="autodeploy/get_project_name";
export const get_projectresource_url ="autodeploy/get_project_resource";
export const getkubernetes_projectbased_url ="autodeploy/getkubernetes_projectbased";
export const getprovisionedresource_projectbased_url ="autodeploy/getprovisionedresource_projectbased";
export const getvalidationforclear = "autodeploy/getvalidationforclear"

/// User Management
export const get_users_url = "users/getusers";
export const get_project_details = "users/get_project_details";
export const get_user_resources = "users/get_resources_provisioned_for_user";
...
export const fetch_configured_resources = "addresource/getconfiguredresources"
...
export const delete_selected_config_url = "addresource/deleteselectedconfigresource";
export const is_projectmgmt_exist = "projects/isprojectexists";


export const getresource_userbased_url = "resourcedynamic/getresource_userbased";

export const update_project_resource_url ="addresource/update_projectresource";