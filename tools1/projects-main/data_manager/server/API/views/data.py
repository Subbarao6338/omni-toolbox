...
def deploy_data(request):
    ...
    if api_type =="POST":
        ...
        elif api_name == "DeployDB":
            url = "https://istudio.thecloudbridge.net/py-api/kubeDeployment/prathameshwar.singh@hcl.com/azure/Graviton/postgres_db20220517T080341304/install-tools-kube-postgresql/app"
        elif api_name == "UnDeployInfra":
            url = "https://istudio.thecloudbridge.net/py-api/InfraCommand/prathameshwar.singh@hcl.com/azure/Graviton/postgres_db20220517T080341304/undeploy-infra"
        ...
        if api_name == "InfraCostLogs":
            url = "https://istudio.thecloudbridge.net/py-api/kubeGetLog/prathameshwar.singh%40hcl.com/azure/Graviton/postgres_db20220517T080341304/infra-price/app"
        elif api_name == "DeployInfraLogs":
            url = "https://istudio.thecloudbridge.net/py-api/kubeGetLog/prathameshwar.singh%40hcl.com/azure/Graviton/postgres_db20220517T080341304/install-infra/app"
        elif api_name == "DeployIstioLogs":
            url = "https://istudio.thecloudbridge.net/py-api/kubeGetLog/prathameshwar.singh%40hcl.com/azure/Graviton/postgres_db20220517T080341304/install-tools-kube-istio/app"
        elif api_name == "DeployDBLogs":
            url = "https://istudio.thecloudbridge.net/py-api/kubeGetLog/prathameshwar.singh%40hcl.com/azure/Graviton/postgres_db20220517T080341304/install-tools-kube-postgresql/app"
        elif api_name == "UnDeployInfraLogs":
            url = "https://istudio.thecloudbridge.net/py-api/kubeGetLog/prathameshwar.singh%40hcl.com/azure/Graviton/postgres_db20220517T080341304/undeploy-infra/app"


    response = requests.request(api_type, url, headers=headers, data=payload)
