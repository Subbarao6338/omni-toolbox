...
def profile_dataframe(df: pd.DataFrame):
    ...
    table = json.loads(simplejson.dumps(complete_json_report.get('table', {}), ignore_nan = True))
    # variables = complete_json_report.get('variables', {})
    variables = json.loads(simplejson.dumps(complete_json_report.get('variables', {}), ignore_nan = True))
