...
import checkpoint_icon from "../assets/icons/checkpoint.png";
import dashboard_icon from "../assets/icons/dashboard.png";
import expectation_icon from "../assets/icons/expectation.png";
import validations_icon from "../assets/icons/validations.png";
import datasource_icon from "../assets/icons/datasource.png";
import streamdata_icon from "../assets/icons/streamdata.png";

const items = [
  { text: "Dashboard", link: "/dashboard", icon_scr: dashboard_icon },
  { text: "Datasource", link: "/datasource", icon_scr: datasource_icon },
  { text: "Expectations", link: "/expectation_suite", icon_scr: expectation_icon },
  { text: "Checkpoint", link: "/checkpoint", icon_scr: checkpoint_icon },
  { text: "Validations", link: "/validations", icon_scr: validations_icon },
  { text: "Streamdata", link: "/stream_validation", icon_scr: streamdata_icon },
]
