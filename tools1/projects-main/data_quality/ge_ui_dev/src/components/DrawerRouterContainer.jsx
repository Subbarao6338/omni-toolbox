...
const items = [
  { id: 0, label: "Dashboard", name: "dashboard", route: "/dashboard" },
  { id: 1, label: "Datasource", name: "datasource", route: "/datasource" },
  // {
  //   id: 2,
  ...
  // },
  {
    ...
    name: "expectation",
    route: "/expectation_suite",
  },
  { id: 4, label: "Checkpoint", name: "checkpoint", route: "/checkpoint" },
  { id: 5, label: "Validations", name: "validations", route: "/validations" },
  // {
  //   id: 6,
  //   label: "Stream Data",
  //   name: "streamdata",
  //   route: "/stream_validation",
  // },
  // { id: 7, label: "Reports", name: "reports", route: "/reports" },
  {
    id: 8,
    label: "Wizard",
    name: "wizard",
    route: "/data_onboarding_wizard",
  },
  // { id: 9, label: 'Details', name: 'wizard', route: '/details' },
];
