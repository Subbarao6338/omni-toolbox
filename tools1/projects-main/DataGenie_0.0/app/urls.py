...
urlpatterns = [
    ...
    url(r'^sdv_model_training', views.sdv_model_training, name='sdv_model_training'),
    ...
    url(r'^data_simulator', views.data_simulator, name='data_simulator'),
    ...
    url(r'^data_generated_list', views.generated_list, name='generated_list'),
