...
import { fetch_projectmgmt_url, tenant_id, update_projectmgmt_url, delete_projectmgmt_url } from "../../commonUtility/api_urls";
import { httpget, httpput, httpdelete ,addnew_notifications} from "../../commonUtility/common_http";
            ...
            if (item.projectname === result.value) {
             ...
             // alert("hi");
              Swal.fire({
                ...
                icon: "error",
                text: "project names don’t match",
              });
            }        
          }
        })
