        ...
        >
          ...
          <div className="row ms-3 " style={{ height: 120 }}>
            {reports.map((report) => (
              ...
              >
                <Link to={{ pathname: report.report_url }} target="_blank">
                  <img
                    alt="thumbnail"
        ...
        >
          ...
          <div className="row ms-3 " style={{ height: 120 }}>
            {frameworks.map((frameworks) => (
              ...
              >
                <Link to={{ pathname: frameworks.report_url }} target="_blank">
                  <img
                    alt="thumbnail"
                    style={{ width: 170, height: 80 }}
                    src={require('../assets/reports_thumbnail/' +
        ...
        >
          ...
          <div className="row ms-3 " style={{ height: 120 }}>
            {dasboards.map((dashboard) => (
              ...
              >
                <Link to={{ pathname: dashboard.report_url }} target="_blank">
                  <img
                    alt="thumbnail"
                    style={{ width: 170, height: 80 }}
                    src={require('../assets/reports_thumbnail/' +
