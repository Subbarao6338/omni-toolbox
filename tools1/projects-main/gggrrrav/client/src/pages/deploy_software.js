...
import { deploy_software_url } from "../commonUtility/api_urls";
...
const DeployApplication = () => {
  ...
  const DeploySoftware = (api_name, api_type) => {
    ...
    httpget_notification(deploy_software_url, req_value).then((result) => {
      console.log(result);
            ...
            <div class="css_table">
              ...
              <div class="css_table_body">
                <div class="css_table_row">
                  ...
                  <div>
                    {" "}
                    <Link onClick={() => DeploySoftware("DeployInfra", "POST")}>
                      <img
                    ...
                    <Link
                      onClick={() => DeploySoftware("DeployInfraLogs", "GET")}
                    >
                      <img
                    ...
                    <br />
                    <Link onClick={() => DeploySoftware("InfraCost", "POST")}>
                      <img
                        data-tip="Infra Cost"
                        data-place="bottom"
                        data-background-color="#006ab6"
                    ...
                    <Link
                      onClick={() => DeploySoftware("InfraCostLogs", "GET")}
                    >
                      <img
                  ...
                  <div>
                    {" "}
                    <Link
                      onClick={() => DeploySoftware("UnDeployInfra", "POST")}
                    >
                      <img
                    ...
                    <Link
                      onClick={() => DeploySoftware("UnDeployInfraLogs", "GET")}
                    >
                      <img
                ...
                <div class="css_table_row">
                  ...
                  <div>
                    {" "}
                    <Link onClick={() => DeploySoftware("DeployIstio", "POST")}>
                      <img
                    ...
                    <Link
                      onClick={() => DeploySoftware("DeployIstioLogs", "GET")}
                    >
                      <img
                ...
                <div class="css_table_row">
                  <div>Applications (Docker Image)</div>
                  <div>
                    {" "}
                    <Link
                      onClick={() =>
                        DeploySoftware("DeployApplications", "POST")
                      }
                    >
                      <img
                        data-tip="Deploy Application"
                        data-place="bottom"
                        data-background-color="#006ab6"
                        src={DeployImage}
                        alt="DeployImage"
                    ...
                    <Link
                      onClick={() =>
                        DeploySoftware("DeployApplicationsLogs", "GET")
                      }
                    >
                      <img
                        data-tip="Deploy Application Logs"
                        data-place="bottom"
                        data-background-color="#006ab6"
                        src={LogsImage}
                        alt="LogsImage"
