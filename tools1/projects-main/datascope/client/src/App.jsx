...
// Resource Provisioning Start
import ResourceProvisioning from "./pages/resourceProvisioning/index.js";
import Airflow from "./pages/resourceProvisioning/airflow";
import Kubernetes from "./pages/resourceProvisioning/kubernetes";
import ResourceProvisioningDPAdmin from "./pages/resourceProvisioning/resource_provisioning_dpadmin";
import Addresource from "./pages/resourceProvisioning/addresource";
import Deleteresource from "./pages/resourceProvisioning/deleteresource";
import Projectresource from "./pages/resourceProvisioning/assignresource";
import Airbyte from "./pages/resourceProvisioning/airbyte";
// Resource Provisioning END
// Centralized Configuration
import CentralConfig from "./pages/CentralConfig/index";
import AddNewConfig from "./pages/CentralConfig/addConfig";
import EditConfig from "./pages/CentralConfig/editConfig";
            ...
            <AzureMsalProvider>
              <Router>
                ...
                <Switch>
                  ...
                  <ProtectedRoute exact path="/airbyte" component={Airbyte} />
                  ...
                  <ProtectedRoute
                    exact
                    path="/central_config/add_config"
                    component={AddNewConfig}
                  />
                  <ProtectedRoute
                    exact
                    path="/central_config/edit_config"
                  ...
                  <ProtectedRoute
                    ...
                    component={ResourceProvisioningDPAdmin}
                  />
                  <ProtectedRoute
                    exact
                    path="/addresource"
