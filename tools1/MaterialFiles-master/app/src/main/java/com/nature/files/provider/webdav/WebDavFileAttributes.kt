...
import com.nature.files.provider.common.AbstractBasicFileAttributes
import com.nature.files.provider.common.BasicFileType
import com.nature.files.provider.common.EPOCH
import com.nature.files.provider.common.FileTimeParceler
import com.nature.files.provider.webdav.client.creationTime
import com.nature.files.provider.webdav.client.isDirectory
import com.nature.files.provider.webdav.client.isSymbolicLink
import com.nature.files.provider.webdav.client.lastModifiedTime
import com.nature.files.provider.webdav.client.size
