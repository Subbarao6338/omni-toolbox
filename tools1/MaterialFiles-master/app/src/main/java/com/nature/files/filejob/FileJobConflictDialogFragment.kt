...
import com.nature.files.coil.AppIconPackageName
import com.nature.files.compat.requireViewByIdCompat
import com.nature.files.databinding.FileJobConflictDialogViewBinding
import com.nature.files.file.FileItem
import com.nature.files.file.fileSize
import com.nature.files.file.formatShort
import com.nature.files.file.iconRes
import com.nature.files.file.lastModifiedInstant
import com.nature.files.filelist.appDirectoryPackageName
import com.nature.files.filelist.supportsThumbnail
import com.nature.files.provider.common.isEncrypted
import com.nature.files.util.ParcelableArgs
import com.nature.files.util.ParcelableState
import com.nature.files.util.RemoteCallback
import com.nature.files.util.args
import com.nature.files.util.finish
import com.nature.files.util.getArgs
import com.nature.files.util.getState
import com.nature.files.util.layoutInflater
import com.nature.files.util.putArgs
import com.nature.files.util.putState
import com.nature.files.util.readParcelable
import com.nature.files.util.setTextWithSelection
import com.nature.files.util.shortAnimTime
import com.nature.files.util.showSoftInput
...
class FileJobConflictDialogFragment : AppCompatDialogFragment() {
    ...
    /** @see com.nature.files.filelist.FileListAdapter.onBindViewHolder */
