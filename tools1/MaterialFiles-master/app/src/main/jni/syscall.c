...
static jclass getSyscallExceptionClass(JNIEnv *env) {
    ...
    if (!syscallExceptionClass) {
        syscallExceptionClass = findClass(env,
                "com/nature/files/provider/linux/syscall/SyscallException");
    }
...
static jclass getByteStringClass(JNIEnv *env) {
    ...
    if (!byteStringClass) {
        byteStringClass = findClass(env, "com/nature/files/provider/common/ByteString");
    }
...
static jclass getInt32RefClass(JNIEnv *env) {
    ...
    if (!int32RefClass) {
        int32RefClass = findClass(env, "com/nature/files/provider/linux/syscall/Int32Ref");
    }
...
static jclass getStructDirentClass(JNIEnv *env) {
    ...
    if (!structStatClass) {
        structStatClass = findClass(env,
                "com/nature/files/provider/linux/syscall/StructDirent");
    }
...
static jclass getStructGroupClass(JNIEnv *env) {
    ...
    if (!structGroupClass) {
        structGroupClass = findClass(env,
                "com/nature/files/provider/linux/syscall/StructGroup");
    }
...
static jclass getStructInotifyEventClass(JNIEnv *env) {
    ...
    if (!structInotifyEventClass) {
        structInotifyEventClass = findClass(env,
                "com/nature/files/provider/linux/syscall/StructInotifyEvent");
    }
...
static jclass getStructMntentClass(JNIEnv *env) {
    ...
    if (!structMntentClass) {
        structMntentClass = findClass(env,
                "com/nature/files/provider/linux/syscall/StructMntent");
    }
...
static jfieldID getStructMntentMntOptsField(JNIEnv *env) {
    ...
    if (!structMntentMntOptsField) {
        structMntentMntOptsField = findField(env, getStructMntentClass(env), "mnt_opts",
                "Lcom/nature/files/provider/common/ByteString;");
    }
...
static jclass getStructPasswdClass(JNIEnv *env) {
    ...
    if (!structPasswdClass) {
        structPasswdClass = findClass(env,
                "com/nature/files/provider/linux/syscall/StructPasswd");
    }
...
static jclass getStructStatClass(JNIEnv *env) {
    ...
    if (!structStatClass) {
        structStatClass = findClass(env,
                "com/nature/files/provider/linux/syscall/StructStat");
    }
    return structStatClass;
}
...
static jclass getStructTimespecClass(JNIEnv *env) {
    ...
    if (!structTimespecClass) {
        structTimespecClass = findClass(env,
                "com/nature/files/provider/linux/syscall/StructTimespec");
    }
...
Java_com_nature_files_provider_linux_syscall_Syscall_access(
...
Java_com_nature_files_provider_linux_syscall_Syscall_chmod(
        JNIEnv *env, jclass clazz, jobject javaPath, jint javaMode) {
    char *path = mallocStringFromByteString(env, javaPath);
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_chown(
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_closedir(
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_endmntent(
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_endgrent(JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_endpwent(JNIEnv *env, jclass clazz) {
...
Java_com_nature_files_provider_linux_syscall_Syscall_errno(
        JNIEnv *env, jclass clazz) {
    return errno;
}

JNIEXPORT jint JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_fcntl_1int(
...
JNIEXPORT jint JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_fcntl_1void(
...
static jobject newStructGroup(JNIEnv *env, const struct group *group) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructGroupClass(env), "<init>",
                                 "(Lcom/nature/files/provider/common/ByteString;"
                                 "Lcom/nature/files/provider/common/ByteString;I"
                                 "[Lcom/nature/files/provider/common/ByteString;)V");
    }
    jobject gr_name;
    if (group->gr_name) {
...
Java_com_nature_files_provider_linux_syscall_Syscall_getgrent(JNIEnv *env, jclass clazz) {
    while (true) {
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_getgrgid(
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_getgrnam(
...
static jobject newStructMntent(JNIEnv *env, const struct mntent *mntent) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructMntentClass(env), "<init>",
                                 ...
                                 "Lcom/nature/files/provider/common/ByteString;"
                                 "Lcom/nature/files/provider/common/ByteString;"
                                 "Lcom/nature/files/provider/common/ByteString;II)V");
    }
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_getmntent(
        JNIEnv *env, jclass clazz, jlong javaFile) {
    FILE *file = (FILE *) javaFile;
#if __ANDROID_API__ >= __ANDROID_API_L_MR1__
...
static jobject newStructPasswd(JNIEnv *env, const struct passwd *passwd) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructPasswdClass(env), "<init>",
                "(Lcom/nature/files/provider/common/ByteString;II"
                "Lcom/nature/files/provider/common/ByteString;"
                "Lcom/nature/files/provider/common/ByteString;"
                "Lcom/nature/files/provider/common/ByteString;)V");
    }
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_getpwent(JNIEnv *env, jclass clazz) {
    while (true) {
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_getpwnam(
        JNIEnv *env, jclass clazz, jobject javaName) {
    char *name = mallocStringFromByteString(env, javaName);
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_getpwuid(
...
JNIEXPORT jboolean JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_hasmntopt(
...
JNIEXPORT jint JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_inotify_1add_1watch(
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_inotify_1init1(
...
static jobject newStructInotifyEvent(JNIEnv *env, const struct inotify_event *event) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructInotifyEventClass(env), "<init>",
                                 "(IIILcom/nature/files/provider/common/ByteString;)V");
    }
    jint wd = event->wd;
...
Java_com_nature_files_provider_linux_syscall_Syscall_inotify_1get_1events(
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_inotify_1rm_1watch(
...
JNIEXPORT jint JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_ioctl_1int(
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_lchown(
        JNIEnv *env, jclass clazz, jobject javaPath, jint javaUid, jint javaGid) {
    char *path = mallocStringFromByteString(env, javaPath);
    uid_t uid = (uid_t) javaUid;
    gid_t gid = (gid_t) javaGid;
...
Java_com_nature_files_provider_linux_syscall_Syscall_lgetxattr(
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_link(
...
JNIEXPORT jobjectArray JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_llistxattr(
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_lsetxattr(
...
static jobject newStructStat(JNIEnv *env, const struct stat64 *stat) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructStatClass(env), "<init>", "(JJIJIIJJJJ"
                "Lcom/nature/files/provider/linux/syscall/StructTimespec;"
                "Lcom/nature/files/provider/linux/syscall/StructTimespec;"
                "Lcom/nature/files/provider/linux/syscall/StructTimespec;)V");
    }
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_lstat(
        JNIEnv *env, jclass clazz, jobject javaPath) {
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_lutimens(
        JNIEnv *env, jclass clazz, jobject javaPath, jobjectArray javaTimes) {
    doUtimens(env, javaPath, javaTimes, true);
}

JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_mkdir(
        JNIEnv *env, jclass clazz, jobject javaPath, jint javaMode) {
    char *path = mallocStringFromByteString(env, javaPath);
    mode_t mode = (mode_t) javaMode;
...
JNIEXPORT jint JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_mount(
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_open(
...
Java_com_nature_files_provider_linux_syscall_Syscall_opendir(
        JNIEnv *env, jclass clazz, jobject javaPath) {
    char *path = mallocStringFromByteString(env, javaPath);
...
static jobject newStructDirent(JNIEnv *env, const struct dirent64 *dirent) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructDirentClass(env), "<init>",
                                 "(JJIILcom/nature/files/provider/common/ByteString;)V");
    }
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_readdir(
        JNIEnv *env, jclass clazz, jlong javaDir) {
    DIR *dir = (DIR *) javaDir;
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_readlink(
        JNIEnv *env, jclass clazz, jobject javaPath) {
    char *path = mallocStringFromByteString(env, javaPath);
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_realpath(
        JNIEnv *env, jclass clazz, jobject javaPath) {
    char *path = mallocStringFromByteString(env, javaPath);
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_remove(
        JNIEnv *env, jclass clazz, jobject javaPath) {
    char *path = mallocStringFromByteString(env, javaPath);
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_rename(
        JNIEnv *env, jclass clazz, jobject javaOldPath, jobject javaNewPath) {
    char *oldPath = mallocStringFromByteString(env, javaOldPath);
    char *newPath = mallocStringFromByteString(env, javaNewPath);
...
JNIEXPORT jlong JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_sendfile(
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_setgrent(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jlong JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_setmntent(
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_setpwent(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_stat(
        JNIEnv *env, jclass clazz, jobject javaPath) {
...
JNIEXPORT jobject JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_statvfs(
        JNIEnv *env, jclass clazz, jobject javaPath) {
    char *path = mallocStringFromByteString(env, javaPath);
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_symlink(
...
JNIEXPORT void JNICALL
Java_com_nature_files_provider_linux_syscall_Syscall_utimens(
        JNIEnv *env, jclass clazz, jobject javaPath, jobjectArray javaTimes) {
