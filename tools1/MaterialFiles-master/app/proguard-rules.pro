...
# App
-keep class com.nature.files.** implements androidx.appcompat.view.CollapsibleActionView { *; }
-keep class com.nature.files.provider.common.ByteString { *; }
-keep class com.nature.files.provider.linux.syscall.** { *; }
-keepnames class * extends java.lang.Exception
# For Class.getEnumConstants()
-keepclassmembers enum * {
    public static **[] values();
}
-keepnames class com.nature.files.** implements android.os.Parcelable
