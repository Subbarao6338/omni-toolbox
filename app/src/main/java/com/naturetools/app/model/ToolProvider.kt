...
object ToolProvider {
    val tools = listOf(
        ...
        Tool("Record Audio", Icons.Default.Mic, "record_audio", "Audio Lab", Color(0xFFE91E63)),
        ...
        Tool("Karaoke Effect", Icons.Default.Mic, "karaoke_effect", "Audio Lab", Color(0xFFCDDC39)),
